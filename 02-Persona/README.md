...
## 🧪 Uso da Persona nos Testes
A persona foi utilizada como base para:
- Definição de cenários de teste
- Análise de usabilidade e experiência do usuário
- Validação de formuários e mensagens de erro
- Avaliação do fluxo de compra do início ao fim

## 📂 Arquivo Relacionado
- 'Persona_BlazeDemo.pdf'
